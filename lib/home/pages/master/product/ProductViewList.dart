...
class InvoiceProductViewList extends StatelessWidget {
  const InvoiceProductViewList({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("ID", "1"),
                    _details("Name", "Priya"),
                    _details("HSN/SAC", "8754716572"),
                    _details("Date", "2023-10-18:22:48:18"),
                    _details("Category", "	Seeds"),
                    _details("Stock Scale Type", "Stock wise"),
                  ],
                ),
              ),
              const SizedBox(
