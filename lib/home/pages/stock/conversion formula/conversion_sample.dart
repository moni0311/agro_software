...
class ConversionSample extends StatelessWidget {
  const ConversionSample({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("S.No", "1"),
                    _details("From Product", "Meen"),
                    _details("From Qty", "Sumasi Seeds"),
                    _details("To Product",  "-"),
                    _details("To Batch", "A25"),
                    _details("Convert Ratio", "2"),
                  ],
                ),
              ),
              const SizedBox(
