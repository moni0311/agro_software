...
class StockTransferSample extends StatelessWidget {
  const StockTransferSample({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("From Location", "Singanallur"),
                    _details("From Product", "Sumasi Seeds"),
                    _details("From Batch", "A24"),
                    _details("From Quantity", "40"),
                    _details("Reference", "test"),
                    _details("To Location", "Godown"),
                    _details("To Product",  "-"),
                    _details("To Batch", "A25"),
                    _details("To Quantity", "20"),
