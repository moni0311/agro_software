...
import '../../opening_transaction/opening_balance_bulk/add_balancebulk.dart';
import 'add_stock_transfer.dart';
...
class _StockTransferViewState extends State<StockTransferView> {
  ...
  Widget build(BuildContext context) {
    ...
    String productname = 'Stock Transfer';
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const AddStockTransfer()));
        },
        backgroundColor: const Color(0xffAED9BA),
        child: const Icon(
          Icons.add,
