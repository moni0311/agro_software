...
class AddOpenStockbulk extends StatefulWidget {
  const AddOpenStockbulk({super.key});

  @override
  State<AddOpenStockbulk> createState() => _OpeningStockbulkViewState();
}

class _OpeningStockbulkViewState extends State<AddOpenStockbulk> {
