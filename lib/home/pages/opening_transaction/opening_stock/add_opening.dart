...
class AddOpening extends StatelessWidget {
  const AddOpening({super.key});
      ...
      body: ListView(
        children: [
          ...
          const DropdownButtonWidget(
            dropDownItem: ['Uriya-1Kg',
              'Freight Charge-6'
              'Rasam Powder-100GM'

            ],
            selectedItem: 'Uriya-1Kg',
          ),
          const Row(
            children: [
              SizedBox(
          ...
          Inputform(label: 'Quantity', controller: quantity),
          const Row(
            children: [
              SizedBox(
                width: 10,
