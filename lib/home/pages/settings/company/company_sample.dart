...
class CompanySample extends StatelessWidget {
  const CompanySample({super.key});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _details("S.No", "1"),
                    _details("Name", "Demo Software"),
                    _details("Address", "LION STOP,Coimbatore"),
                    _details("Phone", "9047099447"),
                    _details("Whatsapp", "6383912804"),
                    _details("Email", "-"),
                    _details("GS TIN", "3A004"),
                    _details("Bank Name", "HDFC "),
                    _details("Bank Branch", "Varatharajapuram"),
                    _details("Account No", "0012345698"),
                    _details("IFSC CODE", "-"),
                    _details("PL NO", "CBE/PL/0001"),
                    _details("SL NO", "CBE/SL/0003"),
                    _details("FL NO", "CBE/FL/0002"),
