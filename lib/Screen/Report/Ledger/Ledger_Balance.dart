...
class _LedgerBalanceState extends State<LedgerBalance> {
  TextEditingController LedgerBalanceDatecontroller = TextEditingController();

  TextEditingController LedgerBalanceDesignationcontroller =
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DateRangePicker(Controller: LedgerBalanceDatecontroller),
            const Text(
              'Destination',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
            ),
            ...
            CustomDropdownButton(
              ...
              controller: LedgerBalanceDesignationcontroller,
            ),
            const SizedBox(
              height: 30,
            ),
