...
class _TrialsheetState extends State<Trialsheet> {
  TextEditingController GLTrialDatecontroller = TextEditingController();

  TextEditingController GLTrialDesignationcontroller =
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            DateRangePicker(Controller: GLTrialDatecontroller),
            const Text(
              'Destination',
              style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold),
            ),
            ...
            CustomDropdownButton(
              ...
              controller: GLTrialDesignationcontroller,
            ),
            const SizedBox(
              height: 30,
            ),
