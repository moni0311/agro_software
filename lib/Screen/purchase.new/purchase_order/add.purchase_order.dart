...
class AddPurchase_Order extends StatelessWidget {
  const AddPurchase_Order({super.key});
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          Inputform(label: 'Supplier Address', controller: address),
...
*/
          ...
          const DropdownButtonWidget(
              dropDownItem: ['Items Delivery On','Items Delivery Off'],
              selectedItem: 'Items Delivery On'
          ),
          const DropdownButtonWidget(
              dropDownItem: ['Main Location','Singanallur','Perur'],
              selectedItem: 'Main Location'
          ),
          const Row(
            children: [
              SizedBox(
          ...
          Inputform(label: 'Freight', controller: freight),
          const Row(
            children: [
              SizedBox(
                width: 10,
          ...
          Inputform(label: 'Others', controller: others),
