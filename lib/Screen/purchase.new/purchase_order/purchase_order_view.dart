import 'package:agroo_software1/Screen/purchase.new/purchase_order/purchase_order_sample.dart';
import 'package:flutter/material.dart';

import '../../../home/pages/sales/Invoice/add_invoice.dart';
import '../../../home/pages/sales/Invoice/invoice_product_data.dart';
import 'add.purchase_order.dart';
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const AddPurchase_Order()));
        },
        backgroundColor: const Color(0xffAED9BA),
        child: const Icon(
          Icons.add,
