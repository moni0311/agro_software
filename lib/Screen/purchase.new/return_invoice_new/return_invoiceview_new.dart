import 'package:agroo_software1/Screen/purchase.new/return_invoice_new/return_invoicesample_new.dart';
import 'package:flutter/material.dart';

import '../../../home/pages/sales/Invoice/add_invoice.dart';
import '../../../home/pages/sales/Invoice/invoice_product_data.dart';
import 'add_return_new.dart';
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(
              MaterialPageRoute(builder: (context) => const AddReturnNew()));
        },
        backgroundColor: const Color(0xffAED9BA),
        child: const Icon(
          Icons.add,
